  ...
  return (
    <div className="relative pointer-events-auto">
      <div 
        ...
        className="w-32 h-32 sm:w-40 sm:h-40 relative bg-white/20 backdrop-blur-sm rounded-full border border-white/40 shadow-lg flex items-center justify-center"
      ...
      >
        ...
        <div 
          ...
          style={{
            ...
            boxShadow: isActive ? '0 10px 25px rgba(250, 49, 167, 0.5)' : '0 4px 15px rgba(0,0,0,0.2)'
          }}
        />
      </div>
    </div>
